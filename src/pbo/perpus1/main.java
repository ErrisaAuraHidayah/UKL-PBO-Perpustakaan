...
public class main {
    ...
    public static void main(String[] args) {
        ...
        //Object yang berisi daftar buku
        listBuku listBuku = new listBuku();

        //object yang berisi daftar siswa
        ...
        while (stay) {
            ...
            if (menu == 1) {
                ...
                /**
                 * prepare variabel "selectedIDSiswa" utk menyimpan data id
                 * siswa yg dipilih, variabel "selectedIDBuku" utk menyimpan
                 * data id buku yg dipilih
                 */
                ...
                /**
                 * "foundIndex" menyimpan posisi index dari data siswa yg
                 * dipilih
                 */
